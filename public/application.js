...
/***/ (function(module, exports, __webpack_require__) {
	...
	var interactions = __webpack_require__(32);
...
/***/ (function(module, exports) {
	...
	// ADD MODULE AND BUTTONS FOR AJAX THEN GO BACK INTO BACKEND AND USE DB TO CHECK

	var config = {
	  apiOrigins: {
	    development: 'http://localhost:4741',
	    production: 'https://pure-sands-32480.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  signUp(data).then(function (response) {
	    ...
	    signIn(authData).then(function (data) {
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  changePassword(data).then(ui.onChangePasswordSuccess).catch(ui.changePasswordFailure);
	};

	var onLogOut = function onLogOut(event) {
	  event.preventDefault();
	  logOut().then(ui.onLogOutSuccess).catch(ui.failure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var moviesTemplate = __webpack_require__(11);
	var movieTemplate = __webpack_require__(31);
	var store = __webpack_require__(9);

	var getMoviesSuccess = function getMoviesSuccess(data) {
	  var moviesHTML = moviesTemplate({ movies: data.movies });
	  $('.poster-board').prepend(moviesHTML);
	};
	var onGetOneMovieSuccess = function onGetOneMovieSuccess(data) {
	  var moviesHTML = movieTemplate({ movie: data.movie });
	  $('.poster-board').prepend(moviesHTML);
	};
	var createNewMovieSuccess = function createNewMovieSuccess(data) {
	  store.movie = data.movie;
	  $('.form-control').val('');
	  $('.form-control').attr('placeholder', '');
	};
	var onMovieUpdateSuccess = function onMovieUpdateSuccess(data) {};
	var onDeleteMovieSuccess = function onDeleteMovieSuccess(data) {
	  clear();
	};
	...
	var addNotesFailure = function addNotesFailure() {
	  $('.form-control').val('');
	  $('.notes-form-input').attr('placeholder', 'Oops! Please try again.');
	};

	var addMovieFailure = function addMovieFailure() {
	  $('.form-control').val('');
	...
	var chooseMovie = function chooseMovie() {
	  ...
	  var movieTitle = $(randomChoice).children().children().children('.movie-title').text();
	...
	module.exports = {
	  ...
	  onGetOneMovieSuccess: onGetOneMovieSuccess,
	  createNewMovieSuccess: createNewMovieSuccess,
	  onDeleteMovieSuccess: onDeleteMovieSuccess,
	  onMovieUpdateSuccess: onMovieUpdateSuccess,
	  ...
	  addNotesFailure: addNotesFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n      <div class=\"list col-xs-12 "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.genres : stack1), depth0))
	    + "\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.watched : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      </div>\n\n";
	  ...
	  return "          <div class=\"movie\">\n            <h5 data-id=\""
	    ...
	    + "\" class=\"watched\"><span class=\"movie-genre\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.genres : stack1), depth0))
	    + ":</span> <span class=\"movie-genre\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></h5>\n            <hr class=\"notes hide\">\n            <p class=\"notes hide\"> Notes: "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.notes : stack1), depth0))
	    + " </p>\n          </div>\n          <form id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" class=\"hide addNotesForm\">\n            <input name=\"movie[notes]\" class=\"form-inline notes-form-input\" type=\"text\" placeholder=\"Notes\">\n            <button type=\"submit\" class=\"btn btn-default notes-form-element handle-btn\">Add Notes</button>\n          </form>\n          <div id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" class=\"remove-button\">X</div>\n          <div id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" class=\"watched check-button\">O</div>\n";
	},"4":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, helper, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : (container.nullContext || {}), alias4=helpers.helperMissing, alias5="function";

	  return "          <div class=\"movie\">\n            <h5 data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"\"><span class=\"movie-genre\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.genres : stack1), depth0))
	    + "</span>: <span class=\"movie-title\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.title : stack1), depth0))
	    + "</span></h5>\n            <hr class=\"notes hide\">\n            <p class=\"notes hide\">Notes: "
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.notes : stack1), depth0))
	    + " </p>\n          </div>\n          <form id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" class=\"hide addNotesForm\">\n            <input name=\"movie[notes]\" class=\"form-inline notes-form-input\" type=\"text\" placeholder=\"Notes\">\n            <button class=\"btn btn-default notes-form-element handle-btn\">Add Notes</button>\n          </form>\n          <div id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" class=\"remove-button\">X</div>\n          <div id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" class=\"check-button\">O</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <h5 data-id=\""
	    ...
	    + "\" class=\"movie watched\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.genres : stack1), depth0))
	    + ": "
	  ...
	  return "<div class=\"list col-xs-12\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.watched : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "  <!-- <hr class=\"\">\n  <p class=\"notes\"> "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetMovies = function onGetMovies(event) {
	  api.getMovies().then(function (data) {
	    ui.clear();
	    var reverseMovies = data.movies.sort(function compare(a, b) {
	      if (a.id < b.id) {
	        return 1;
	      }if (a.id > b.id) {
	        return -1;
	    ...
	    var moviesHTML = moviesTemplate({ movies: reverseMovies });
	...
	var onGetOneMovie = function onGetOneMovie(event) {
	  api.getOneMovie().then(ui.onGetOneMovieSuccess).catch(ui.failure);
	};

	var createNewMovie = function createNewMovie(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.newMovie(data).then(function (data) {
	    $('.form-control').val('');
	    $('.form-control').attr('placeholder', '');
	    store.movie = data.movie;
	    onGetMovies();
	...
	var onDeleteMovie = function onDeleteMovie(data) {
	  api.deleteMovie(this.id).then(function () {
	    ui.onDeleteMovieSuccess();
	    onGetMovies();
	  }).catch(ui.failure);
	};

	var onMovieUpdate = function onMovieUpdate(data) {
	  var movie = $(this);
	  if (movie.hasClass('watched')) {
	    event.preventDefault();
	    api.movieUnwatch(this.id).then(function () {
	      ui.onMovieUpdateSuccess;
	      onGetMovies();
	    }).catch(ui.failure);
	  } else {
	    event.preventDefault();
	    api.movieWatch(this.id).then(function () {
	      ui.onMovieUpdateSuccess;
	      onGetMovies();
	    }).catch(ui.failure);
	  }
	...
	var onAddNotes = function onAddNotes(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  data.movie.id = this.id;
	  api.addNotes(data).then(function () {
	    onGetMovies();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var movieWatch = function movieWatch(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/movies/' + data,
	    method: 'PATCH',
	    headers: {
	...
	var movieUnwatch = function movieUnwatch(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/movies/' + data,
	    method: 'PATCH',
	    headers: {
	...
	var addNotes = function addNotes(data) {
	  return $.ajax({
